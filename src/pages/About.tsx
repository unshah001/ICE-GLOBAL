...
import {  } from "@/components/ui/background-effects";
...
const fallbackAbout: AboutContent = {
  ...
  partners: {
    ...
    cta: { label: "View a partner story", href: "/brands" },
  },
  work: {
    badge: "Work with us",
      ...
      <section className="section-padding bg-card/40 border-y border-border/60">
        <div className="container-custom space-y-8">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            ...
            <Button asChild variant="outline">
              <Link to="/brands">{about.partners.cta.label || "View a partner story"}</Link>
            </Button>
          </div>
