...
const Footer = ({ data }: { data?: FooterData }) => {
  ...
  return (
    <footer className="bg-card border-t border-border">
      ...
      <div className="container-custom section-padding">
        ...
        {/* ❌ removed motion.div */}
        <div className="relative overflow-hidden rounded-3xl border border-border/60 bg-card/80 px-6 py-10 md:px-10 md:py-14 shadow-xl shadow-primary/10">
  ...
  <Button
    ...
    size="lg"
className="!bg-[length:100%_100%] !animate-none overflow-hidden antialiased !shadow-none border border-blue/6 bg-black text-white">
   <a href={data?.sponsorHref || "/sponsor"}>
      Sponsor an Event
    </a>
  </Button>
